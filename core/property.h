...
namespace MV {
    ...
    /// \class BasePropertyArray MV/core/properties.h
    ...
    /// \class PropertyArray MV/core/properties.h
    template <class T>
    ...
    /// \class Property MV/core/properties.h
    template <class T>
    class Property
    {
    public:
    ...
    /// \class PropertyContainer MV/core/properties.h
