...
namespace MV {
     ...
     * \class PolyMesh MV/core/poly_mesh.h
    ...
    public: //--------------------------------------------------- memory management
        ...
        unsigned int n_vertices() const { return (unsigned int) m_vprops.size(); }
        /// returns number of edges in the mesh
        unsigned int n_edges() const { return (unsigned int) m_eprops.size(); }
    ...
    private: //---------------------------------------------- allocate new elements
        ...
        Edge new_edge(Vertex s, Vertex t)
        {
            ...
            m_econn[e].vertices_ = {s, t};
            m_vconn[s].edges_.insert(e);
            m_vconn[t].edges_.insert(e);
            m_vconn[s].vertices_.insert(t);
            m_vconn[t].vertices_.insert(s);
            return e;
        }
        ...
        HalfFace new_face()
        {
            ...
            m_hconn[h0].opposite_ = h1;
            m_hconn[h1].opposite_ = h0;
    ...
    private: //------------------------------------------------------- private data
        ...
        HalfFaceProperty<HalfFaceConnectivity>  m_hconn;
