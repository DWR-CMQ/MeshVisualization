...
namespace MV {
     ...
     *
     * \class SurfaceMesh MV/core/surface_mesh.h
    ...
    public: //----------------------------------------------- add new vertex / face
        ...
        Vertex add_vertex(const vec3& p) { Vertex v = new_vertex(); m_vpoint[v] = p; return v; }
    ...
    public: //--------------------------------------------------- memory management
        ...
        unsigned int vertices_size() const { return (unsigned int) m_vprops.size(); }
        ...
        unsigned int edges_size() const { return (unsigned int) m_eprops.size(); }
        /// returns number of (deleted and valid)faces in the mesh
        unsigned int faces_size() const { return (unsigned int) fprops_.size(); }


        /// returns number of vertices in the mesh
        unsigned int n_vertices() const { return vertices_size() - m_uideletedvertices; }
        /// returns number of halfedge in the mesh
        unsigned int n_halfedges() const { return halfedges_size() - 2*m_uideletededges; }
        /// returns number of edges in the mesh
        unsigned int n_edges() const { return edges_size() - m_uideletededges; }
        /// returns number of faces in the mesh
        unsigned int n_faces() const { return faces_size() - m_deleted_faces; }
        ...
        bool has_garbage() const { return m_bgarbage; }
    ...
    public: //--------------------------------------------------- property handling
        ...
        {
            return ModelProperty<T>(m_mprops.add<T>(name, t));
        }
        ...
        {
            return ModelProperty<T>(m_mprops.get<T>(name));
        }
        ...
        {
            return VertexProperty<T>(m_vprops.get_or_add<T>(name, t));
        }
        ...
        {
            return EdgeProperty<T>(m_eprops.get_or_add<T>(name, t));
        }
        ...
        {
            return ModelProperty<T>(m_mprops.get_or_add<T>(name, t));
        }


        /// remove the vertex property \c p
        template<class T>
        bool remove_vertex_property(VertexProperty<T> &p) { return m_vprops.remove(p); }

        /// remove the vertex property named \c n
        bool remove_vertex_property(const std::string &n) { return m_vprops.remove(n); }
        ...
        template<class T>
        bool remove_edge_property(EdgeProperty<T> &p) { return m_eprops.remove(p); }

        /// remove the edge property named \c n
        bool remove_edge_property(const std::string &n) { return m_eprops.remove(n); }
        ...
        template<class T>
        bool remove_model_property(ModelProperty<T> &p) { return m_mprops.remove(p); }

        /// remove the model property named \c n
        bool remove_model_property(const std::string &n) { return m_mprops.remove(n); }

        /// rename a vertex property given its name
        bool rename_vertex_property(const std::string &old_name, const std::string &new_name) {
            return m_vprops.rename(old_name, new_name);
        }
        ...
        bool rename_edge_property(const std::string &old_name, const std::string &new_name) {
            return m_eprops.rename(old_name, new_name);
        }
        ...
        bool rename_model_property(const std::string &old_name, const std::string &new_name) {
            return m_mprops.rename(old_name, new_name);
        }
    ...
    public: //------------------------------------------ geometry-related functions
        ...
        const vec3& position(Vertex v) const { return m_vpoint[v]; }

        /// position of a vertex
        vec3& position(Vertex v) { return m_vpoint[v]; }

        /// vector of vertex positions (read only)
        const std::vector<vec3>& points() const override { return m_vpoint.vector(); }

        /// vector of vertex positions
        std::vector<vec3>& points() override { return m_vpoint.vector(); }
    ...
    private: //------------------------------------------------------- private data
        ...
        VertexProperty<vec3>  m_vpoint;
        VertexProperty<vec3>  m_vnormal;
        FaceProperty<vec3>    m_fnormal;

        unsigned int m_uideletedvertices;
        unsigned int m_uideletededges;
        unsigned int m_deleted_faces;
        bool m_bgarbage;
