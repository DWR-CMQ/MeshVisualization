...
namespace MV
{
//std::vector<Normal> BaseDenoise::GetFaceNormal(const SurfaceMesh& mesh)
//{
...
//}
//
//std::vector<Scalar> BaseDenoise::GetFaceArea(const SurfaceMesh& mesh)
//{
...
//std::vector<Point> BaseDenoise::GetFaceCentroid(const SurfaceMesh& mesh)
//{
