                ...
                for (unsigned int jj = 0; jj < grp.face_count; ++jj) {
                    ...
                    if (face.is_valid()) {
                        ...
                        if (prop_face_color) {
                            ...
                            prop_face_color[face] = vec3(mat.Kd); // current implementation of MV uses only diffuse
                        }
                    }
                }
            }
...
#include "../3dparty/tinyobjloader/tiny_obj_loader.h"
