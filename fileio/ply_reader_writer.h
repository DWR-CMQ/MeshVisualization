...
namespace MV {
	...
	namespace io {
        ...
        /// \class GenericProperty MV/fileio/ply_reader_writer.h
        ...
        /// \class Element MV/fileio/ply_reader_writer.h
		struct Element {
        ...
        /// \class PlyReader MV/fileio/ply_reader_writer.h
		class PlyReader
		{
		public:
            PlyReader() = default;
		...
		/// \details This class is internally used by PointCloudIO, SurfaceMeshIO, and GraphIO.
		/// Client code should use PointCloudIO, SurfaceMeshIO, and GraphIO.
        /// \class PlyWriter MV/fileio/ply_reader_writer.h
		class PlyWriter {
		public:
            /**
